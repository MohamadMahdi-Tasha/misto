            ...
            <PageComponent pageName={'product'}>
                <PageSectionsComponent pageName={'product'} sectionNumber={'first'}>
                    <div className='page--product__breadcrumb-holder'>
                        ...
                        <button className='page--product__share-btn'>
                    ...
                    <h1 className='page--product__product-name'>{info.name}</h1>
                ...
                <PageSectionsComponent pageName={'product'} sectionNumber={'second'}>
                    <img className='page--product__product-img' src={info.image} alt={info.name} />
                    <div className='page--product__product-content'>
                        <h6 className='page--product__product-color'>COLOR:<span>Blue</span></h6>
                        <hr className='page--product__product-content-line'/>
