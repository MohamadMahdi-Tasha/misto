    ...
    if (props.type === 'localization') {
        ...
        return (
            <>
                <HeaderNavDropdownCollapseComponent>
                    <button className='header__nav-dropdown-collapse-btn'>1</button>
                    <button className='header__nav-dropdown-collapse-btn'>2</button>
                    <button className='header__nav-dropdown-collapse-btn'>3</button>
                    <button className='header__nav-dropdown-collapse-btn'>4</button>
                </HeaderNavDropdownCollapseComponent>
        ...
        return (
            <>
                ...
                <form className='header__nav-dropdown-login-form' action="#">
                    ...
                    <div className='header__nav-dropdown-login-form-div'>
                        <div className='header__nav-dropdown-login-password-top-side'><label className='header__nav-dropdown-login-label' htmlFor="password">PASSWORD</label><a className='header__nav-dropdown-login-link' href="#">Lost your password?</a></div>
                ...
                <div className='header__nav-dropdown-bottom-btns-holder'>
                    <a href="#"><button tabIndex='-1' className='header__nav-dropdown-bgwhite-btn'>New Customer?</button></a>
                    <a href="#"><button tabIndex='-1' className='header__nav-dropdown-bgrey-btn'>Create your account</button></a>
                </div>
            </>
        );
        ...
        return (
            <>
                ...
                <div className='header__nav-dropdown-bottom-btns-holder'>
                    <a href="#"><button tabIndex='-1' className='header__nav-dropdown-submit-btn'>Check Out</button></a>
                    <a href="#"><button tabIndex='-1' className='header__nav-dropdown-bgrey-btn'>View Cart</button></a>
                </div>
            </>
        );
    }
