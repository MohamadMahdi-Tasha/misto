    ...
    if (props.type === 'localization') {
        return (
            <div className='header__nav-dropdown-holder'>
                <div className='header__nav-dropdown-bg'></div>
                    ...
                    <div className='header__nav-dropdown-content-holder'>
                        ...
                        <form className='header__nav-dropdown-radio-form' action="#">
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='english'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="english">English</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='Українська'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label'
                                       htmlFor="Українська">Українська</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='Français'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="Français">Français</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='Español'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="Español">Español</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='Polskie'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="Polskie">Polskie</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='langRadio' id='Türkçe'
                                       type="radio"/>
                        ...
                        <form className='header__nav-dropdown-radio-form' action="#">
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='USD'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="USD">USD ( US Dollar
                                    )</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='UAH'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="UAH">UAH ( Ukraine Hryvnia
                                    )</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='EUR'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="EUR">EUR ( Euro )</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='PLN'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="PLN">PLN ( Polish Zloty
                                    )</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='TRY'
                                       type="radio"/>
                                <label className='header__nav-dropdown-radio-label' htmlFor="TRY">TRY ( Turkish Lira
                                    )</label>
                            </div>
                            <div className='header__nav-dropdown-radio-holder'>
                                <input className='header__nav-dropdown-radio' name='currencyRadio' id='KRW'
                                       type="radio"/>
                            ...
                            <ul className='header__nav-dropdown-inspration-list'>
                                <li className='header__nav-dropdown-inspration'>
                                    <a className='header__nav-dropdown-inspration-link' href="#">
                                        <img className='header__nav-dropdown-inspration-img' src={IMG}
                                             alt="Women's tracksuit Q109"/>
                                        <div className='header__nav-dropdown-inspration-content'>
                                            <h6 className='header__nav-dropdown-inspration-title'>Women's tracksuit
                                                Q109</h6>
                ...
                <div className='header__nav-dropdown'>
                    ...
                    <div className='header__nav-dropdown-content-holder'>
                        ...
                        <form action="#">
                            ...
                            <input className='header__nav-dropdown-login-input' type="email"
                            ...
                            <input className='header__nav-dropdown-login-input' type="password"
                        ...
                        <ul className='header__nav-dropdown-list-of-ways-to-login'>
                            ...
                            <li><a href="#">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M37.3332 20.1053C37.3332 10.4718 29.5751 2.66653 19.9998 2.66653C10.4246 2.66653 2.6665 10.4718 2.6665 20.1053C2.6665 28.8093 9.00505 36.0239 17.2915 37.3332V25.1464H12.8883V20.1053H17.2915V16.2632C17.2915 11.8929 19.8775 9.47892 23.8383 9.47892C25.7352 9.47892 27.7188 9.81926 27.7188 9.81926V14.1086H25.5325C23.3798 14.1086 22.7082 15.4531 22.7082 16.8321V20.1053H27.5154L26.7466 25.1464H22.7082V37.3332C30.9946 36.0239 37.3332 28.8093 37.3332 20.1053Z"
                                        fill="#121212"/>
                                </svg>
                            </a></li>
                        </ul>
                        <a href="#">
                            <button className='header__nav-dropdown-bgwhite-btn'>New Customer?</button>
                        </a>
                        <a href="#">
                            <button className='header__nav-dropdown-bggrey-btn'>Create your account</button>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div className='header__nav-dropdown-holder'>
                ...
                <div className='header__nav-dropdown'>
                    ...
                    <div className='header__nav-dropdown-holder'>
                        ...
                        <a href="#">
                            <button className='header__nav-dropdown-submit-btn'>Check Out</button>
                        </a>
                        <a href="#">
                            <button className='header__nav-dropdown-bggrey-btn'>View Cart</button>
                        </a>
                    </div>
                </div>
            </div>
