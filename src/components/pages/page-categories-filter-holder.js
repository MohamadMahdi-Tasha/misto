...
export default function PageCategoriesFilterHolderComponent() {
    // Returning JSX
    return (
        <div className='page__categories-filter-holder'>
            <div className='page__categories-filter-top-side'>
                <button className='page__categories-filter-btn'>
                ...
                <div className='page__categories-filter-grid-btns-holder'>
                    <button className='page__categories-filter-grid-btns'>
                ...
                <div className='page__categories-filter-dropdown-holder'>
